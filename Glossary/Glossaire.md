...
- Source : référence à la source où le terme est défini (ex: ISTQB CTFL 1.2, IEEE 829, Agile Testing)
...
|---------|----------|------------|--------|
| **Analysis** | Analyse | Processus d'examen détaillé d'un élément pour identifier ses composants, leurs relations et leurs principes d'organisation. | ISTQB CTFL |
| **API** | Interface de programmation | Interface qui permet à différents logiciels de communiquer entre eux. | General Testing |
| **API Testing** | Tests d'API | Tests réalisés en soumettant des commandes au logiciel testé via les interfaces de programmation de l'application directement. | ISTQB CTAL-TAE |
| **Backend** | Arrière-plan | Partie serveur d'une application qui gère la logique métier et les données. | General Testing |
...
| **Measure** | Mesure | Nombre ou catégorie assigné à un attribut d'une entité par le biais d'une mesure. | ISTQB CTAL-TM |
